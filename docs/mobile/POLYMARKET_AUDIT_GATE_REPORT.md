...
Scope: Portfolio History side contract.

Evidence:

- Mobile proof: `docs/mobile/harness/cycle-NO-portfolio-history-side-contract/cycle-NO-portfolio-history-side-contract.json`
- Focused tests: `mobile/src/__tests__/portfolioHistoryService.test.ts`
- Audit file: `mobile/docs/audits/cycle-NO-portfolio-history-side-contract.md`

Decision: pass for focused backend/data-contract scope. Server-mode Portfolio History recentTrades and canceledOrders require `BUY` or `SELL` side values before visible History activity applies.
...
Scope: Portfolio history price bounds contract.

Evidence:

- Mobile proof: `docs/mobile/harness/cycle-MZ-portfolio-history-price-bounds-contract/cycle-MZ-portfolio-history-price-bounds-contract.json`
- Focused tests: `mobile/src/__tests__/portfolioHistoryService.test.ts`
- Audit file: `mobile/docs/audits/cycle-MZ-portfolio-history-price-bounds-contract.md`

Decision: pass for focused backend/data-contract scope. Server-mode Portfolio history rejects canceled order prices and inferred recent trade execution prices outside `0` to `1` before visible History state applies.
...
Scope: Quote price bounds contract.

Evidence:

- Mobile proof: `docs/mobile/harness/cycle-MW-quote-price-bounds-contract/cycle-MW-quote-price-bounds-contract.json`
- Focused tests: `mobile/src/__tests__/quoteService.test.ts`
- Audit file: `mobile/docs/audits/cycle-MW-quote-price-bounds-contract.md`

Decision: pass for focused backend/data-contract scope. Server-mode quote routes reject above-one price fields before visible ticket/card odds apply while preserving large depth sizes and failed-market guard behavior.
...
Scope: Trade Ticket order lifecycle consistency contract.

Evidence:

- Mobile proof: `docs/mobile/harness/cycle-MT-order-lifecycle-consistency-contract/cycle-MT-order-lifecycle-consistency-contract.json`
- Focused tests: `mobile/src/__tests__/orderService.test.ts`
- Audit file: `mobile/docs/audits/cycle-MT-order-lifecycle-consistency-contract.md`

Decision: pass for focused backend/data-contract scope. Server-mode Trade Ticket submit rejects negative lifecycle values and impossible `/api/orders` confirmations where remaining, fills, or fills plus remaining exceed order size before visible order state applies.

## Cycle MS

Gate status: Pass

Scope: Event list quote price bounds contract.

Evidence:

- Mobile proof: `docs/mobile/harness/cycle-MS-event-list-quote-price-bounds-contract/cycle-MS-event-list-quote-price-bounds-contract.json`
- Focused tests: `mobile/src/__tests__/eventListRouteShapeService.test.ts`, `mobile/src/__tests__/liveEventFeedService.test.ts`
- Audit file: `mobile/docs/audits/cycle-MS-event-list-quote-price-bounds-contract.md`

Decision: pass for focused backend/data-contract scope. Server-mode Home/Search/Live/Futures compact event-list routes reject outcome quote prices outside `0` to `1` before frontend normalization or visible card rendering while still accepting large backend depth sizes.

## Cycle MR

Gate status: Pass

Scope: Cashout fill plus remaining lifecycle contract.

Evidence:

- Mobile proof: `docs/mobile/harness/cycle-MR-cashout-fill-remaining-contract/cycle-MR-cashout-fill-remaining-contract.json`
- Focused tests: `mobile/src/__tests__/positionCloseRouteShapeService.test.ts`, `mobile/src/__tests__/positionCloseService.test.ts`
- Audit file: `mobile/docs/audits/cycle-MR-cashout-fill-remaining-contract.md`

Decision: pass for focused backend/data-contract scope. Server-mode cashout rejects impossible confirmations where returned fill total plus remaining exceeds returned order size before Portfolio refresh treats cashout as accepted.

## Cycle MQ

Gate status: Pass

Scope: Event Detail quote price bounds contract.

Evidence:

- Mobile proof: `docs/mobile/harness/cycle-MQ-event-detail-quote-price-bounds-contract/cycle-MQ-event-detail-quote-price-bounds-contract.json`
- Focused tests: `mobile/src/__tests__/eventDetailRouteShapeService.test.ts`, `mobile/src/__tests__/eventDetailHydrationService.test.ts`
- Audit file: `mobile/docs/audits/cycle-MQ-event-detail-quote-price-bounds-contract.md`

Decision: pass for focused backend/data-contract scope. Server-mode Event Detail rejects outcome quote prices outside `0` to `1` before frontend normalization or game-page market rendering while still accepting large backend depth sizes.
...
| Event Detail quote price bounds contract | Cycle MQ | Pass for backend/data-contract scope | 0 for focused Event Detail quote bounds scope | P2 optional field-specific Event Detail quote error copy | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Mobile proof: `docs/mobile/harness/cycle-MQ-event-detail-quote-price-bounds-contract/cycle-MQ-event-detail-quote-price-bounds-contract.json`; tests: `mobile/src/__tests__/eventDetailRouteShapeService.test.ts`, `mobile/src/__tests__/eventDetailHydrationService.test.ts`; audit: `mobile/docs/audits/cycle-MQ-event-detail-quote-price-bounds-contract.md` | Server-mode Event Detail now rejects outcome quote prices outside `0` to `1` before frontend normalization or game-page market rendering while still accepting large backend depth sizes. |
...
| Cashout current price contract | Cycle ML | Pass for backend/data-contract scope | 0 for focused cashout current price scope | P2 optional richer unavailable-price row copy | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Mobile proof: `docs/mobile/harness/cycle-ML-cashout-current-price-contract/cycle-ML-cashout-current-price-contract.json`; tests: `mobile/src/__tests__/positionCloseService.test.ts`, `mobile/src/__tests__/positionCloseRouteShapeService.test.ts`; audit: `mobile/docs/audits/cycle-ML-cashout-current-price-contract.md` | Server-mode cashout now requires finite positive current price and blocks missing/zero current price before submit instead of falling back to entry probability. |
| Cashout confirmation size contract | Cycle MK | Pass for backend/data-contract scope | 0 for focused cashout confirmation size scope | P2 optional richer cashout confirmation mismatch copy | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Mobile proof: `docs/mobile/harness/cycle-MK-cashout-confirmation-size-contract/cycle-MK-cashout-confirmation-size-contract.json`; tests: `mobile/src/__tests__/positionCloseRouteShapeService.test.ts`, `mobile/src/__tests__/positionCloseService.test.ts`; audit: `mobile/docs/audits/cycle-MK-cashout-confirmation-size-contract.md` | Server-mode cashout now rejects returned confirmation sizes that differ from the requested sell-all full-position size before Portfolio refresh treats cashout as accepted. |
| Event Detail rule consistency contract | Cycle MJ | Pass for backend/data-contract scope | 0 for focused Event Detail rule consistency scope | P2 optional Event Detail rule-specific error copy | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Mobile proof: `docs/mobile/harness/cycle-MJ-event-detail-rule-consistency-contract/cycle-MJ-event-detail-rule-consistency-contract.json`; tests: `mobile/src/__tests__/eventDetailRouteShapeService.test.ts`, `mobile/src/__tests__/eventDetailHydrationService.test.ts`, `mobile/src/__tests__/eventDetailMarketProfileService.test.ts`; audit: `mobile/docs/audits/cycle-MJ-event-detail-rule-consistency-contract.md` | Event Detail route validation now rejects contradictory draw-rule metadata and unsupported market profiles before visible primary/regulation market selection applies. |
| Event Detail market count contract | Cycle MI | Pass for backend/data-contract scope | 0 for focused Event Detail market count scope | P2 optional Event Detail count-specific error copy | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Mobile proof: `docs/mobile/harness/cycle-MI-event-detail-market-count-contract/cycle-MI-event-detail-market-count-contract.json`; tests: `mobile/src/__tests__/eventDetailRouteShapeService.test.ts`, `mobile/src/__tests__/eventDetailHydrationService.test.ts`; audit: `mobile/docs/audits/cycle-MI-event-detail-market-count-contract.md` | Event Detail route validation now rejects malformed or inconsistent market counts before visible game page state applies. |
| Event Detail score contract | Cycle MH | Pass for backend/data-contract scope | 0 for focused Event Detail score scope | P2 optional Event Detail score-specific error copy | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Mobile proof: `docs/mobile/harness/cycle-MH-event-detail-score-contract/cycle-MH-event-detail-score-contract.json`; tests: `mobile/src/__tests__/eventDetailRouteShapeService.test.ts`, `mobile/src/__tests__/eventDetailHydrationService.test.ts`; audit: `mobile/docs/audits/cycle-MH-event-detail-score-contract.md` | Event Detail route validation now rejects negative home/away scores before visible game page state applies while preserving null pre-match/unknown scores. |
| Event list non-negative quote contract | Cycle MG | Pass for backend/data-contract scope | 0 for focused event-list quote/depth scope | P2 optional surface-specific event-list quote error copy | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Mobile proof: `docs/mobile/harness/cycle-MG-event-list-nonnegative-quote-contract/cycle-MG-event-list-nonnegative-quote-contract.json`; tests: `mobile/src/__tests__/eventListRouteShapeService.test.ts`, `mobile/src/__tests__/liveEventFeedService.test.ts`; audit: `mobile/docs/audits/cycle-MG-event-list-nonnegative-quote-contract.md` | Event-list route validation now rejects negative or malformed outcome quote/depth fields before Home/Search/Live/Futures card state applies. |
| Portfolio history economics contract | Cycle MF | Pass for backend/data-contract scope | 0 for focused Portfolio history economics scope | P2 optional field-specific Portfolio history error copy | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Mobile proof: `docs/mobile/harness/cycle-MF-portfolio-history-economics-contract/cycle-MF-portfolio-history-economics-contract.json`; tests: `mobile/src/__tests__/portfolioHistoryService.test.ts`; audit: `mobile/docs/audits/cycle-MF-portfolio-history-economics-contract.md` | Portfolio history now rejects negative resolved payout, recent-trade, and canceled-order economics before visible activity applies while allowing negative realized P/L. |
...
| Portfolio value history route shape contract | Cycle MA | Pass for backend/data-contract scope | 0 for focused value-history route-shape scope | P2 optional route-specific retry/error copy | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Mobile proof: `docs/mobile/harness/cycle-MA-portfolio-value-history-route-shape-contract/cycle-MA-portfolio-value-history-route-shape-contract.json`; tests: `mobile/src/__tests__/portfolioValueHistoryService.test.ts`; audit: `mobile/docs/audits/cycle-MA-portfolio-value-history-route-shape-contract.md` | Portfolio value history now validates requested range, route metadata, empty state, and non-negative value fields before visible chart state applies. |
| Account navigation enabled contract | Cycle LZ | Pass for backend/data-contract scope | 0 for focused account navigation enabled scope | P2 optional field-specific Account navigation error copy | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Mobile proof: `docs/mobile/harness/cycle-LZ-account-navigation-enabled-contract/cycle-LZ-account-navigation-enabled-contract.json`; tests: `mobile/src/__tests__/accountNavigationService.test.ts`; audit: `mobile/docs/audits/cycle-LZ-account-navigation-enabled-contract.md` | Account navigation enabled state now rejects malformed route values instead of JavaScript truthiness coercion. |
| Account profile boolean contract | Cycle LY | Pass for backend/data-contract scope | 0 for focused account profile boolean scope | P2 optional field-specific Account profile error copy | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Mobile proof: `docs/mobile/harness/cycle-LY-account-profile-boolean-contract/cycle-LY-account-profile-boolean-contract.json`; tests: `mobile/src/__tests__/accountProfileService.test.ts`; audit: `mobile/docs/audits/cycle-LY-account-profile-boolean-contract.md` | Account profile linked-state booleans now reject malformed route values instead of JavaScript truthiness coercion. |
| Cashout submit confirmation contract | Cycle LX | Pass for backend/data-contract scope | 0 for focused cashout submit confirmation scope | P2 optional richer cashout submit error copy | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Mobile proof: `docs/mobile/harness/cycle-LX-cashout-submit-confirmation-contract/cycle-LX-cashout-submit-confirmation-contract.json`; tests: `mobile/src/__tests__/positionCloseRouteShapeService.test.ts`, `mobile/src/__tests__/positionCloseService.test.ts`; audit: `mobile/docs/audits/cycle-LX-cashout-submit-confirmation-contract.md` | Server-mode cashout now validates `/api/orders` submit confirmation before Portfolio refresh treats sell-all close as accepted. |
| Cancel route shape contract | Cycle LW | Pass for backend/data-contract scope | 0 for focused cancel route-shape scope | P2 optional richer cancel-race copy/action | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Mobile proof: `docs/mobile/harness/cycle-LW-cancel-route-shape-contract/cycle-LW-cancel-route-shape-contract.json`; tests: `mobile/src/__tests__/cancelOrderRouteShapeService.test.ts`, `mobile/src/__tests__/openOrderService.test.ts`; audit: `mobile/docs/audits/cycle-LW-cancel-route-shape-contract.md` | Portfolio server-mode cancel now validates `/api/orders/:id` response identity and `CANCELED` status before visible cancel confirmation. |
| Event Detail route shape contract | Cycle LV | Pass for backend/data-contract scope | 0 for focused Event Detail route-shape scope | P2 optional Event Detail route-specific retry/error copy | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Mobile proof: `docs/mobile/harness/cycle-LV-event-detail-route-shape-contract/cycle-LV-event-detail-route-shape-contract.json`; tests: `mobile/src/__tests__/eventDetailRouteShapeService.test.ts`, `mobile/src/__tests__/eventDetailHydrationService.test.ts`; audit: `mobile/docs/audits/cycle-LV-event-detail-route-shape-contract.md` | Event Detail hydration now validates backend game rule fields, supported market types, market rows, and outcome quote fields before visible route-backed detail state is applied. |
| Orderbook route shape contract | Cycle LU | Pass for backend/data-contract scope | 0 for focused orderbook route-shape scope | P2 optional depth-specific retry copy | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Mobile proof: `docs/mobile/harness/cycle-LU-orderbook-route-shape-contract/cycle-LU-orderbook-route-shape-contract.json`; tests: `mobile/src/__tests__/orderbookRouteShapeService.test.ts`, `mobile/src/__tests__/marketDepthService.test.ts`; audit: `mobile/docs/audits/cycle-LU-orderbook-route-shape-contract.md` | Event Detail selected-market depth now validates `/api/orderbook/:marketId/book` identity, availability, empty-state, and level arrays before visible route-backed depth is applied. |
...
| Home futures chart contract | Cycle KR | Pass for backend/data-contract scope | 0 for focused Home futures chart route scope | P1 provider-backed futures volume/open-interest metrics beyond price history | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Route/mobile proof: `docs/mobile/harness/cycle-KR-home-futures-chart-contract/cycle-KR-home-futures-chart-contract.json`; tests: `src/__tests__/public.market-chart.no-leak.test.ts`, `mobile/src/__tests__/futuresChartService.test.ts`, `mobile/src/__tests__/api.test.ts`; audit: `mobile/docs/audits/cycle-KR-home-futures-chart-contract.md` | Home futures chart/range controls now load `/api/markets/:id/chart?range=<selected>` in server mode, including the visible `1H` range, and expose route source/status/range/point-count on the chart harness label. |
...
| Account profile contract | Cycle KI | Pass for backend/data-contract scope | 0 for focused Account profile identity route scope | P1 full server-authored Account menu destinations/actions; P1 richer Account-specific sync/error copy | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Route/mobile proof: `docs/mobile/harness/cycle-KI-account-profile-contract/cycle-KI-account-profile-contract.json`; tests: `mobile/src/__tests__/accountProfileService.test.ts`, `mobile/src/__tests__/api.test.ts`; audit: `mobile/docs/audits/cycle-KI-account-profile-contract.md` | Mobile server mode now calls canonical `/api/account/profile`, maps backend `displayName`, and replaces the hardcoded demo Account name when profile sync succeeds. |
| Account balance contract | Cycle KH | Pass for backend/data-contract scope | 0 for focused Account visible balance route scope | P1 full server-authored account identity/session/menu metadata; P1 richer account sync status/error surface | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Route/mobile proof: `docs/mobile/harness/cycle-KH-account-balance-contract/cycle-KH-account-balance-contract.json`; tests: `mobile/src/__tests__/accountBalanceService.test.ts`, `mobile/src/__tests__/api.test.ts`; audit: `mobile/docs/audits/cycle-KH-account-balance-contract.md` | Mobile server mode now calls canonical `/api/account/balance`, normalizes decimal-string balances for visible Account state, and proof verifies `/api/portfolio` wallet consistency for the same user. |
| Route sell/cashout safety | Cycle KG | Pass for backend/data-contract scope | 0 for focused no-position, oversell, and valid full-position sell route scope | P1 provider-backed close/cashout replay on exact live markets | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Route proof: `docs/mobile/harness/cycle-KG-route-sell-safety/cycle-KG-route-sell-safety.json`; tests: `mobile/src/__tests__/positionCloseService.test.ts`, `src/server/services/__tests__/phase7_kalshi_model.test.ts`; audit: `mobile/docs/audits/cycle-KG-route-sell-safety.md` | `POST /api/orders` rejects no-position SELL and oversell with `409`, Portfolio remains unmutated, and a valid sell-all close is accepted and reserves owned shares. |
...
| Trade Ticket filled lifecycle | Cycle JY | Pass for backend/data-contract scope | 0 for focused filled submit/Portfolio/history contract scope | P1 filled lifecycle breadth across more market families and partial-fill states; P1 richer mobile filled/partial status copy; P1 durable first-class fill/trade selection snapshots | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Route proof: `docs/mobile/harness/cycle-JY-trade-ticket-filled-lifecycle/cycle-JY-trade-ticket-filled-lifecycle.json`; tests: `mobile/src/__tests__/orderService.test.ts`, `mobile/src/__tests__/portfolioSnapshotService.test.ts`, `mobile/src/__tests__/portfolioHistoryService.test.ts`; audit: `mobile/docs/audits/cycle-JY-trade-ticket-filled-lifecycle.md` | A provider-backed No-side ticket fills through `POST /api/orders` against route-created maker liquidity. The order response returns `FILLED`, one fill, and buyer position shares; `/api/portfolio` and `/api/portfolio/history` preserve the same provider token, external market id, contract side, and limit metadata. |
| Trade Ticket submit contract | Cycle JX | Pass for backend/data-contract scope | 0 for focused submit/open-order contract scope | P1 route-backed filled lifecycle for this ticket path; P1 richer mobile submit error states; P1 durable first-class order/fill/trade selection snapshots | Product decision on 2026-07-06: manual UI review is no longer required for every cycle; backend wiring and harness evidence are the priority | Route proof: `docs/mobile/harness/cycle-JX-trade-ticket-submit-contract/cycle-JX-trade-ticket-submit-contract.json`; tests: `mobile/src/__tests__/orderService.test.ts`, `mobile/src/__tests__/api.test.ts`; audit: `mobile/docs/audits/cycle-JX-trade-ticket-submit-contract.md` | `POST /api/orders` accepts a provider-backed No-side ticket selection through canonical auth, returns a confirmed order id/selection, replays idempotently, and `/api/portfolio` exposes the open order with the same provider token, external market id, contract side, and limit metadata. Mobile server mode no longer invents an id when backend confirmation is missing. |
...
Lead Agent target: Ensure server-mode cashout confirmations reject impossible remaining-size lifecycle data before Portfolio refresh.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Tightened cashout confirmation lifecycle validation, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-MO-cashout-remaining-size-contract.md`
- `docs/mobile/harness/cycle-MO-cashout-remaining-size-contract/cycle-MO-cashout-remaining-size-contract.json`
- `scripts/prove_mobile_cashout_remaining_size_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| MO-P0-01 | P0 | Pass | Equal remaining and size accepted. | N/A |
| MO-P0-02 | P0 | Pass | Lower remaining than size accepted. | N/A |
| MO-P0-03 | P0 | Pass | Nested remaining above size rejects before Portfolio refresh. | N/A |
| MO-P0-04 | P0 | Pass | Top-level remaining above size rejects before Portfolio refresh. | N/A |
| MO-P2-01 | P2 | Open | No richer cashout lifecycle mismatch copy. | Optional later copy pass. |

Decision:

- Pass/fail: Pass for focused cashout remaining size contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional richer cashout lifecycle mismatch copy.

## Cycle MN

Gate status: Pass

Lead Agent target: Ensure route-backed Event Detail includes backend-owned game-rule fields before frontend market selection applies.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Tightened Event Detail route required-field validation, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-MN-event-detail-required-rules-contract.md`
- `docs/mobile/harness/cycle-MN-event-detail-required-rules-contract/cycle-MN-event-detail-required-rules-contract.json`
- `scripts/prove_mobile_event_detail_required_rules_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| MN-P0-01 | P0 | Pass | Valid regulation/draw rules accepted. | N/A |
| MN-P0-02 | P0 | Pass | Valid advance/no-draw rules accepted. | N/A |
| MN-P0-03 | P0 | Pass | Missing `marketProfile` rejects before visible apply. | N/A |
| MN-P0-04 | P0 | Pass | Missing `resultMode` rejects before visible apply. | N/A |
| MN-P0-05 | P0 | Pass | Missing `gameRules` rejects before visible apply. | N/A |
| MN-P0-06 | P0 | Pass | Missing `supportedMarketTypes` rejects before visible apply. | N/A |
| MN-P2-01 | P2 | Open | No missing-rule-field Event Detail error copy. | Optional later copy pass. |

Decision:

- Pass/fail: Pass for focused Event Detail required rules contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional missing-rule-field Event Detail error copy.

## Cycle MM

Gate status: Pass

Lead Agent target: Ensure server-mode cashout current price stays within binary contract bounds before submit.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Tightened cashout current price bounds, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-MM-cashout-price-bounds-contract.md`
- `docs/mobile/harness/cycle-MM-cashout-price-bounds-contract/cycle-MM-cashout-price-bounds-contract.json`
- `scripts/prove_mobile_cashout_price_bounds_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| MM-P0-01 | P0 | Pass | `currentPrice=1.00` is cashout-available. | N/A |
| MM-P0-02 | P0 | Pass | `currentPrice>1.00` is cashout-unavailable. | N/A |
| MM-P0-03 | P0 | Pass | `currentPrice=0` is cashout-unavailable. | N/A |
| MM-P0-04 | P0 | Pass | `currentPrice=1.00` submits price `1.00`. | N/A |
| MM-P0-05 | P0 | Pass | Above-one current price rejects before submit. | N/A |
| MM-P0-06 | P0 | Pass | Missing current price rejects before submit. | N/A |
| MM-P2-01 | P2 | Open | No richer invalid-price row copy. | Optional later copy pass. |

Decision:

- Pass/fail: Pass for focused cashout price bounds contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional richer invalid-price row copy.

## Cycle ML

Gate status: Pass

Lead Agent target: Ensure server-mode cashout uses current price and blocks missing/invalid current price before submit.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Removed entry-probability fallback for server cashout submit, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-ML-cashout-current-price-contract.md`
- `docs/mobile/harness/cycle-ML-cashout-current-price-contract/cycle-ML-cashout-current-price-contract.json`
- `scripts/prove_mobile_cashout_current_price_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| ML-P0-01 | P0 | Pass | Position with current price is cashout-available. | N/A |
| ML-P0-02 | P0 | Pass | Missing current price is cashout-unavailable. | N/A |
| ML-P0-03 | P0 | Pass | Zero current price is cashout-unavailable. | N/A |
| ML-P0-04 | P0 | Pass | Valid cashout uses current price. | N/A |
| ML-P0-05 | P0 | Pass | Missing current price rejects before submit. | N/A |
| ML-P0-06 | P0 | Pass | Zero current price rejects before submit. | N/A |
| ML-P2-01 | P2 | Open | No richer unavailable-price row copy. | Optional later copy pass. |

Decision:

- Pass/fail: Pass for focused cashout current price contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional richer unavailable-price row copy.

## Cycle MK

Gate status: Pass

Lead Agent target: Ensure server-mode cashout confirmation size matches the requested sell-all full-position size when returned.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Tightened cashout confirmation validation, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-MK-cashout-confirmation-size-contract.md`
- `docs/mobile/harness/cycle-MK-cashout-confirmation-size-contract/cycle-MK-cashout-confirmation-size-contract.json`
- `scripts/prove_mobile_cashout_confirmation_size_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| MK-P0-01 | P0 | Pass | Matching full-position confirmation size accepted. | N/A |
| MK-P0-02 | P0 | Pass | Legacy id-only confirmation remains accepted. | N/A |
| MK-P0-03 | P0 | Pass | Smaller confirmed size rejects before Portfolio refresh. | N/A |
| MK-P0-04 | P0 | Pass | Larger confirmed size rejects before Portfolio refresh. | N/A |
| MK-P2-01 | P2 | Open | No richer cashout mismatch copy. | Optional later copy pass. |

Decision:

- Pass/fail: Pass for focused cashout confirmation size contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional richer cashout confirmation mismatch copy.

## Cycle MJ

Gate status: Pass

Lead Agent target: Ensure Event Detail backend game-rule metadata rejects contradictory values before visible primary/regulation market selection applies.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Tightened Event Detail route rule consistency validation, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-MJ-event-detail-rule-consistency-contract.md`
- `docs/mobile/harness/cycle-MJ-event-detail-rule-consistency-contract/cycle-MJ-event-detail-rule-consistency-contract.json`
- `scripts/prove_mobile_event_detail_rule_consistency_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| MJ-P0-01 | P0 | Pass | Valid regulation/draw rules accepted. | N/A |
| MJ-P0-02 | P0 | Pass | Valid advance/no-draw rules accepted. | N/A |
| MJ-P0-03 | P0 | Pass | `can_draw` with `allowDraw=false` rejects before visible apply. | N/A |
| MJ-P0-04 | P0 | Pass | `no_draw` with `allowDraw=true` rejects before visible apply. | N/A |
| MJ-P0-05 | P0 | Pass | Market profile missing from supported market types rejects before visible apply. | N/A |
| MJ-P2-01 | P2 | Open | No rule-specific Event Detail error copy. | Optional later copy pass. |

Decision:

- Pass/fail: Pass for focused Event Detail rule consistency contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional Event Detail rule-specific error copy.

## Cycle MI

Gate status: Pass

Lead Agent target: Ensure Event Detail route market counts reject malformed or inconsistent values before visible game page state applies.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Tightened Event Detail route count validation, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-MI-event-detail-market-count-contract.md`
- `docs/mobile/harness/cycle-MI-event-detail-market-count-contract/cycle-MI-event-detail-market-count-contract.json`
- `scripts/prove_mobile_event_detail_market_count_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| MI-P0-01 | P0 | Pass | Valid non-negative integer market counts accepted. | N/A |
| MI-P0-02 | P0 | Pass | String market count rejects before visible apply. | N/A |
| MI-P0-03 | P0 | Pass | Negative active market count rejects before visible apply. | N/A |
| MI-P0-04 | P0 | Pass | Fractional market count rejects before visible apply. | N/A |
| MI-P0-05 | P0 | Pass | Active market count above total rejects before visible apply. | N/A |
| MI-P2-01 | P2 | Open | No count-specific Event Detail error copy. | Optional later copy pass. |

Decision:

- Pass/fail: Pass for focused Event Detail market count contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional Event Detail count-specific error copy.

## Cycle MH

Gate status: Pass

Lead Agent target: Ensure Event Detail route scores reject negative values before visible game page state applies.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Tightened Event Detail route validation, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-MH-event-detail-score-contract.md`
- `docs/mobile/harness/cycle-MH-event-detail-score-contract/cycle-MH-event-detail-score-contract.json`
- `scripts/prove_mobile_event_detail_score_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| MH-P0-01 | P0 | Pass | Valid non-negative live scores accepted. | N/A |
| MH-P0-02 | P0 | Pass | Null scores accepted for pre-match/unknown state. | N/A |
| MH-P0-03 | P0 | Pass | Negative home score rejects before visible apply. | N/A |
| MH-P0-04 | P0 | Pass | Negative away score rejects before visible apply. | N/A |
| MH-P2-01 | P2 | Open | No score-specific Event Detail error copy. | Optional later copy pass. |

Decision:

- Pass/fail: Pass for focused Event Detail score contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional Event Detail score-specific error copy.

## Cycle MG

Gate status: Pass

Lead Agent target: Ensure event-list route quote/depth fields reject negative values before Home/Search/Live/Futures visible card state applies.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Tightened shared event-list route validation, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-MG-event-list-nonnegative-quote-contract.md`
- `docs/mobile/harness/cycle-MG-event-list-nonnegative-quote-contract/cycle-MG-event-list-nonnegative-quote-contract.json`
- `scripts/prove_mobile_event_list_nonnegative_quote_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| MG-P0-01 | P0 | Pass | Valid non-negative quote fields accepted. | N/A |
| MG-P0-02 | P0 | Pass | Negative price rejects before visible apply. | N/A |
| MG-P0-03 | P0 | Pass | Negative bid rejects before visible apply. | N/A |
| MG-P0-04 | P0 | Pass | Negative depth size rejects before visible apply. | N/A |
| MG-P0-05 | P0 | Pass | Malformed price rejects before visible apply. | N/A |
| MG-P2-01 | P2 | Open | No surface-specific event-list quote error copy. | Optional later copy pass. |

Decision:

- Pass/fail: Pass for focused event-list non-negative quote contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional surface-specific event-list quote error copy.

## Cycle MF

Gate status: Pass

Lead Agent target: Ensure `/api/portfolio/history` activity economics reject impossible negative values before visible Portfolio activity applies.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Tightened Portfolio history economics validation, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-MF-portfolio-history-economics-contract.md`
- `docs/mobile/harness/cycle-MF-portfolio-history-economics-contract/cycle-MF-portfolio-history-economics-contract.json`
- `scripts/prove_mobile_portfolio_history_economics_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| MF-P0-01 | P0 | Pass | Valid history economics apply. | N/A |
| MF-P0-02 | P0 | Pass | Negative resolved payout rejects before visible apply. | N/A |
| MF-P0-03 | P0 | Pass | Negative trade shares reject before visible apply. | N/A |
| MF-P0-04 | P0 | Pass | Negative trade cost rejects before visible apply. | N/A |
| MF-P0-05 | P0 | Pass | Negative canceled-order economics reject before visible apply. | N/A |
| MF-P0-06 | P0 | Pass | Negative realized P/L remains allowed. | N/A |
| MF-P2-01 | P2 | Open | No field-specific Portfolio history error copy. | Optional later copy pass. |

Decision:

- Pass/fail: Pass for focused Portfolio history economics contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional field-specific Portfolio history error copy.
...
Lead Agent target: Ensure `/api/account/balance` values are non-negative and internally consistent before visible Account state applies.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Tightened Account balance normalization, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-MD-account-balance-shape-contract.md`
- `docs/mobile/harness/cycle-MD-account-balance-shape-contract/cycle-MD-account-balance-shape-contract.json`
- `scripts/prove_mobile_account_balance_shape_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| MD-P0-01 | P0 | Pass | Valid non-negative balance applies. | N/A |
| MD-P0-02 | P0 | Pass | Negative available balance rejects before visible apply. | N/A |
| MD-P0-03 | P0 | Pass | Negative locked balance rejects before visible apply. | N/A |
| MD-P0-04 | P0 | Pass | Inconsistent total balance rejects before visible apply. | N/A |
| MD-P0-05 | P0 | Pass | Malformed updatedAt rejects before visible apply. | N/A |
| MD-P2-01 | P2 | Open | No field-specific Account balance error copy. | Optional later copy pass. |

Decision:

- Pass/fail: Pass for focused Account balance shape contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional field-specific Account balance error copy.

## Cycle MC

Gate status: Pass

Lead Agent target: Ensure `/api/orders` selection echoes validate selected-market identity before visible Trade Ticket submitted-order state applies.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Reused shared selection validation for order submit echoes, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-MC-order-selection-echo-contract.md`
- `docs/mobile/harness/cycle-MC-order-selection-echo-contract/cycle-MC-order-selection-echo-contract.json`
- `scripts/prove_mobile_order_selection_echo_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| MC-P0-01 | P0 | Pass | Legacy id-only submit confirmation remains accepted. | N/A |
| MC-P0-02 | P0 | Pass | Valid future selection echo is preserved. | N/A |
| MC-P0-03 | P0 | Pass | Valid line-market selection echo is preserved. | N/A |
| MC-P0-04 | P0 | Pass | Malformed future selection echo rejects before visible apply. | N/A |
| MC-P0-05 | P0 | Pass | Malformed line selection echo rejects before visible apply. | N/A |
| MC-P2-01 | P2 | Open | No route-specific Trade Ticket order selection error copy. | Optional later copy pass. |

Decision:

- Pass/fail: Pass for focused Order selection echo contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional route-specific Trade Ticket order selection error copy.

## Cycle MB

Gate status: Pass

Lead Agent target: Ensure `/api/portfolio` and `/api/portfolio/history` preserve backend-selected market identity and reject malformed selection fields before visible Portfolio rows apply.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Added shared Portfolio selection validation, wired snapshot/history to it, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-MB-portfolio-selection-identity-contract.md`
- `docs/mobile/harness/cycle-MB-portfolio-selection-identity-contract/cycle-MB-portfolio-selection-identity-contract.json`
- `scripts/prove_mobile_portfolio_selection_identity_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| MB-P0-01 | P0 | Pass | Valid snapshot selection identity is preserved. | N/A |
| MB-P0-02 | P0 | Pass | Valid history selection identity is preserved. | N/A |
| MB-P0-03 | P0 | Pass | Unknown market type rejects before visible apply. | N/A |
| MB-P0-04 | P0 | Pass | Missing display label rejects before visible apply. | N/A |
| MB-P0-05 | P0 | Pass | Invalid limit fields reject before visible apply. | N/A |
| MB-P2-01 | P2 | Open | No route-specific Portfolio selection error copy. | Optional later copy pass. |

Decision:

- Pass/fail: Pass for focused Portfolio selection identity contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional route-specific Portfolio selection error copy.

## Cycle MA

Gate status: Pass

Lead Agent target: Ensure `/api/portfolio/value-history` matches requested range and validates route metadata before visible Portfolio chart state applies.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Tightened Portfolio value-history route validation, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-MA-portfolio-value-history-route-shape-contract.md`
- `docs/mobile/harness/cycle-MA-portfolio-value-history-route-shape-contract/cycle-MA-portfolio-value-history-route-shape-contract.json`
- `scripts/prove_mobile_portfolio_value_history_route_shape_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| MA-P0-01 | P0 | Pass | Valid requested-range value history applies. | N/A |
| MA-P0-02 | P0 | Pass | Wrong range rejects before visible apply. | N/A |
| MA-P0-03 | P0 | Pass | Missing generatedAt rejects before visible apply. | N/A |
| MA-P0-04 | P0 | Pass | Invalid empty state rejects before visible apply. | N/A |
| MA-P0-05 | P0 | Pass | Negative value/cash/positions value rejects before visible apply. | N/A |
| MA-P2-01 | P2 | Open | No route-specific value-history retry/error copy. | Optional later copy pass. |

Decision:

- Pass/fail: Pass for focused Portfolio value history route shape contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional route-specific retry/error copy.

## Cycle LZ

Gate status: Pass

Lead Agent target: Ensure `/api/account/navigation` item enabled fields are real booleans before visible Account menu state applies.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Tightened Account navigation enabled-state normalization, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-LZ-account-navigation-enabled-contract.md`
- `docs/mobile/harness/cycle-LZ-account-navigation-enabled-contract/cycle-LZ-account-navigation-enabled-contract.json`
- `scripts/prove_mobile_account_navigation_enabled_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| LZ-P0-01 | P0 | Pass | Valid boolean enabled navigation applies. | N/A |
| LZ-P0-02 | P0 | Pass | String `enabled` rejects instead of coercing visible state. | N/A |
| LZ-P0-03 | P0 | Pass | Numeric `enabled` rejects instead of coercing visible state. | N/A |
| LZ-P2-01 | P2 | Open | No field-specific Account navigation error copy. | Optional later copy pass. |

Decision:

- Pass/fail: Pass for focused Account navigation enabled contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional field-specific Account navigation error copy.

## Cycle LY

Gate status: Pass

Lead Agent target: Ensure `/api/account/profile` linked-account fields are real booleans before visible Account state applies.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Tightened Account profile boolean normalization, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-LY-account-profile-boolean-contract.md`
- `docs/mobile/harness/cycle-LY-account-profile-boolean-contract/cycle-LY-account-profile-boolean-contract.json`
- `scripts/prove_mobile_account_profile_boolean_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| LY-P0-01 | P0 | Pass | Valid boolean linked-account profile applies. | N/A |
| LY-P0-02 | P0 | Pass | String `hasWalletLinked` rejects instead of coercing visible state. | N/A |
| LY-P0-03 | P0 | Pass | Numeric `hasGoogleLinked` rejects instead of coercing visible state. | N/A |
| LY-P2-01 | P2 | Open | No field-specific Account profile error copy. | Optional later copy pass. |

Decision:

- Pass/fail: Pass for focused Account profile boolean contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional field-specific Account profile error copy.

## Cycle LX

Gate status: Pass

Lead Agent target: Ensure server-mode cashout does not proceed to Portfolio refresh unless `/api/orders` confirms the sell-all close order.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Added cashout submit response validation, wired `closePositionOnServer` through it, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-LX-cashout-submit-confirmation-contract.md`
- `docs/mobile/harness/cycle-LX-cashout-submit-confirmation-contract/cycle-LX-cashout-submit-confirmation-contract.json`
- `scripts/prove_mobile_cashout_submit_confirmation_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| LX-P0-01 | P0 | Pass | Valid sell-all cashout confirmation is accepted. | N/A |
| LX-P0-02 | P0 | Pass | Cashout uses full held shares. | N/A |
| LX-P0-03 | P0 | Pass | Zero-share cashout rejects before submit. | N/A |
| LX-P0-04 | P0 | Pass | Missing order confirmation rejects before Portfolio refresh. | N/A |
| LX-P0-05 | P0 | Pass | Malformed order lifecycle numbers reject before Portfolio refresh. | N/A |
| LX-P2-01 | P2 | Open | No richer cashout submit error copy. | Optional later copy pass. |

Decision:

- Pass/fail: Pass for focused cashout submit confirmation contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional richer cashout submit error copy.

## Cycle LW

Gate status: Pass

Lead Agent target: Ensure Portfolio server-mode cancel confirms only the same canceled order from `/api/orders/:id`.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Added cancel route-shape validation, wired server cancel through it, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-LW-cancel-route-shape-contract.md`
- `docs/mobile/harness/cycle-LW-cancel-route-shape-contract/cycle-LW-cancel-route-shape-contract.json`
- `scripts/prove_mobile_cancel_route_shape_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| LW-P0-01 | P0 | Pass | Same-order `CANCELED` response confirms server cancel. | N/A |
| LW-P0-02 | P0 | Pass | Wrong-order cancel response rejects before visible confirm. | N/A |
| LW-P0-03 | P0 | Pass | Non-canceled status rejects before visible confirm. | N/A |
| LW-P0-04 | P0 | Pass | Malformed payload rejects before visible confirm. | N/A |
| LW-P2-01 | P2 | Open | No richer inline cancel-race copy/action. | Optional later copy/action pass. |

Decision:

- Pass/fail: Pass for focused cancel route shape contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional richer inline cancel-race copy/action.

## Cycle LV

Gate status: Pass

Lead Agent target: Ensure server-mode Event Detail does not apply malformed backend game rules, market rows, or outcome quote fields.

Reference Audit Agent: Backend/data-contract loop. Manual UI review is no longer required every cycle.

Implementation Agent: Added detail route-shape validation, wired app detail loaders through the guarded path, added focused tests, and generated harness proof.

Audit Gate Agent: Proof script, focused mobile tests, root typecheck, mobile typecheck, audit gate, and diff hygiene.

Holiwyn evidence:

- `mobile/docs/audits/cycle-LV-event-detail-route-shape-contract.md`
- `docs/mobile/harness/cycle-LV-event-detail-route-shape-contract/cycle-LV-event-detail-route-shape-contract.json`
- `scripts/prove_mobile_event_detail_route_shape_contract.ts`

Criteria results:

| Criterion ID | Priority | Result | Evidence | Fix if failed |
| --- | --- | --- | --- | --- |
| LV-P0-01 | P0 | Pass | Regulation 90-minute detail with draw hydrates after route validation. | N/A |
| LV-P0-02 | P0 | Pass | Advance/no-draw detail hydrates after route validation. | N/A |
| LV-P0-03 | P0 | Pass | Malformed market profile rejects before Event Detail applies. | N/A |
| LV-P0-04 | P0 | Pass | Missing markets array rejects before Event Detail applies. | N/A |
| LV-P0-05 | P0 | Pass | Malformed outcome quote fields reject before Event Detail applies. | N/A |
| LV-P2-01 | P2 | Open | No Event Detail route-specific retry/error copy. | Optional later copy/action pass. |

Decision:

- Pass/fail: Pass for focused Event Detail route shape contract.
- Unresolved P0 gaps: 0 for selected feature.
- Remaining P1/P2 gaps: optional Event Detail route-specific retry/error copy.
...
- Route identity, availability, empty state, and level numeric validation before visible route-backed depth is applied.

Evidence:

- `docs/mobile/harness/cycle-LU-orderbook-route-shape-contract/cycle-LU-orderbook-route-shape-contract.json`
- `mobile/docs/audits/cycle-LU-orderbook-route-shape-contract.md`
- `mobile/src/__tests__/orderbookRouteShapeService.test.ts`
...
| --- | --- | --- |
| Valid selected-market depth applies visible route-backed rows | Pass | LU proof `validDepthApplies=true` |
| Wrong-market orderbook payload rejects before visible apply | Pass | LU proof `wrongMarketRejects=true` |
| Malformed level data rejects before visible apply | Pass | LU proof `malformedLevelRejects=true` |
| Malformed availability data rejects before visible apply | Pass | LU proof `malformedAvailabilityRejects=true` |

Decision:

- Pass/fail: Pass for focused backend/data-contract scope.
- Remaining: P2 optional depth-specific retry/error copy.
...
- Server-mode quote refresh through `/api/markets/:id/quote`.
- Route envelope and quote row validation before visible odds are applied.
- Malformed payload classification as quote failure for existing availability guards.

Evidence:

- `docs/mobile/harness/cycle-LS-quote-route-shape-contract/cycle-LS-quote-route-shape-contract.json`
- `mobile/docs/audits/cycle-LS-quote-route-shape-contract.md`
...
| Criterion | Result | Evidence |
| --- | --- | --- |
| Valid quote route payload applies visible odds | Pass | LS proof `validQuoteRouteAppliesOdds=true` |
| Malformed quote numeric fields reject before fallback odds | Pass | LS proof `malformedNumericRejects=true` |
| Wrong-market quote payload rejects before apply | Pass | LS proof `wrongMarketRejects=true` |
| Malformed bulk quote payload marks market failed | Pass | LS proof `malformedBulkQuoteMarksMarketFailed=true` |
| No unresolved P0 remains for focused quote route-shape scope | Pass | Route map, gap tracker, and cycle audit updated |

Decision:

- Pass/fail: Pass for focused backend/data-contract scope.
- Remaining: P2 optional quote-specific retry/error copy.
...
- Shared `/api/events?includeMobileMarkets=1` route-shape validation for Home, Search, Live, and Futures.
- Rejection of malformed compact event-list payloads before normalization and visible state apply.

Evidence:

- `docs/mobile/harness/cycle-LR-event-list-route-shape-contract/cycle-LR-event-list-route-shape-contract.json`
- `mobile/docs/audits/cycle-LR-event-list-route-shape-contract.md`
- `mobile/src/__tests__/eventListRouteShapeService.test.ts`
...
| Criterion | Result | Evidence |
| --- | --- | --- |
| Valid Home-style event-list page is accepted | Pass | LR proof `validHomePageAccepted=true` |
| Valid Search-style event-list page is accepted | Pass | LR proof `validSearchPageAccepted=true` |
| Valid Futures event-list page is accepted | Pass | LR proof `validFuturesPageAccepted=true` |
| Missing market arrays reject before frontend detail/fallback rows | Pass | LR proof `missingMarketsRejects=true` |
...
- Pass/fail: Pass for focused backend/data-contract scope.
- Remaining: P2 optional surface-specific retry/error copy.
...
- Account preferences route response normalization for visible mobile state.
- GET default payload, PUT saved echo, persisted GET reload, and malformed response rejection.

Evidence:

- `docs/mobile/harness/cycle-LD-account-preferences-response-contract/cycle-LD-account-preferences-response-contract.json`
- `mobile/docs/audits/cycle-LD-account-preferences-response-contract.md`
...
| Criterion | Result | Evidence |
| --- | --- | --- |
| Default route payload normalizes to mobile Account preferences state | Pass | LD proof `defaultRoutePayloadNormalizesToMobileState=true` |
| Saved PUT route echo normalizes to visible mobile state | Pass | LD proof `savedRoutePayloadNormalizesToVisibleMobileState=true` |
| Persisted GET route payload matches saved mobile state | Pass | LD proof `persistedRoutePayloadMatchesSavedMobileState=true` |
| Malformed preference fields are rejected before applying visible state | Pass | LD proof `malformedPreferenceFieldsRejectedBeforeApply=true`; focused unit tests |
| Legacy missing slippage remains compatible | Pass | `profilePreferencesService.test.ts` keeps the `1%` default for older payloads |

Decision:

- Pass/fail: Pass for focused Account preferences response contract.
- Unresolved P0 gaps: 0 for focused preference response-shape scope.
- Remaining P1/P2 gaps: richer retry/conflict UI if preference save fails mid-session.
...
- Cashout/sell safety contract for visible Portfolio and Event Detail position actions.
- Backend route/data proof for no-position SELL, oversell, and valid sell-all.

Evidence:

- `docs/mobile/harness/cycle-LA-cashout-sell-safety-contract/cycle-LA-cashout-sell-safety-contract.json`
- `mobile/docs/audits/cycle-LA-cashout-sell-safety-contract.md`
- `mobile/src/__tests__/positionCloseService.test.ts`
- `src/server/services/__tests__/phase7_kalshi_model.test.ts`

Criteria:

| Criterion | Result | Evidence |
| --- | --- | --- |
| Server-mode cashout is disabled/blocked when a position has zero or missing shares | Pass | `canCashOutPosition` unit tests and LA proof `mobileService.zeroSharePositionDisabled=true` |
| Invalid frontend cashout does not call the API | Pass | LA proof `mobileService.invalidCashoutMessage` and `validCashoutApiCalls=1` after only the valid close |
| Cashout-all estimate uses current value/current price while backend submit uses all held shares | Pass | `cashOutEstimate` tests and `closePositionOnServer` valid order size test |
| Backend rejects no-position SELL even if frontend fails | Pass | LA proof `routeSafety.noPositionSellRejected.status=409` |
| Backend rejects oversell and preserves Portfolio state | Pass | LA proof `routeSafety.oversellRejected.status=409`, `sharesAfter=2`, `openOrdersAfter=0` |
| Backend accepts valid sell-all and reserves all shares | Pass | LA proof `routeSafety.validSellAllAccepted.status=200`, `side=SELL`, `reservedSharesAfter=2` |
...
Scope: Backend/data-contract gate for mixed knockout Event Detail primary/Game Lines market selection.
...
- Cycle audit: `mobile/docs/audits/cycle-KY-event-detail-mixed-profile-contract.md`.
- Focused tests:
  - `mobile/src/__tests__/eventDetailMarketProfileService.test.ts`
  - `mobile/src/__tests__/eventDetailHydrationService.test.ts`
  - `mobile/src/__tests__/worldCupAdapter.test.ts`
  - `mobile/src/__tests__/api.test.ts`
- Proof script:
  - `scripts/prove_mobile_event_detail_mixed_profile_contract.ts`

Decision:

- Pass for focused backend/data-contract scope.
- Mobile now preserves `to_advance` as a game-line market type.
- Mixed knockout Event Detail selects `to_advance` for primary buttons and a separate `regulation_90`/moneyline market with Home/Tie/Away for Game Lines.
- Pure advance markets are not reused as fake regulation Game Lines.
- No remaining P1/P2 gaps for the focused mixed-profile Event Detail contract.

## Cycle KX

Gate status: Pass

Scope: Backend/data-contract gate for Event Detail one-team-advances/no-draw route profile.
...
- Cycle audit: `mobile/docs/audits/cycle-KX-event-detail-advance-contract.md`.
- Focused tests:
  - `mobile/src/__tests__/eventDetailHydrationService.test.ts`
  - `mobile/src/__tests__/worldCupAdapter.test.ts`
  - `mobile/src/__tests__/api.test.ts`
- Proof script:
  - `scripts/prove_mobile_event_detail_advance_contract.ts`

Decision:

- Pass for focused backend/data-contract scope.
- Event Detail hydration has route/mobile proof for `marketProfile=to_advance`, `resultMode=no_draw`, `allowDraw=false`, and `includesOvertime=true`.
- Proof verifies the hydrated detail has exactly two non-draw outcomes.
- No remaining P1/P2 gaps for the focused advance/no-draw Event Detail contract.

## Cycle KW

Gate status: Pass

Scope: Backend/data-contract gate for Event Detail discovery-card hydration key and route-owned game rules.
...
- Cycle audit: `mobile/docs/audits/cycle-KW-event-detail-hydration-contract.md`.
- Focused tests:
  - `mobile/src/__tests__/eventDetailHydrationService.test.ts`
  - `mobile/src/__tests__/worldCupAdapter.test.ts`
  - `mobile/src/__tests__/api.test.ts`
- Proof script:
  - `scripts/prove_mobile_event_detail_hydration_contract.ts`

Decision:

- Pass for focused backend/data-contract scope.
- Mobile normalized summaries now preserve backend `slug` as `backendSlug`.
- Server-mode Event Detail card hydration now requests the backend slug for `/api/mobile/events/:slug/live-detail`.
- Proof verifies slug lookup returns 200, database id lookup returns 404, and hydrated regulation detail keeps `marketProfile=regulation_90`, `resultMode=can_draw`, `allowDraw=true`, and a draw outcome.
- No remaining P1/P2 gaps for the focused Event Detail hydration key/rules contract.
...
Scope: Backend/data-contract gate for visible Live tab event feed.

Evidence:

- Route/mobile proof: `docs/mobile/harness/cycle-KU-live-tab-feed-contract/cycle-KU-live-tab-feed-contract.json`.
- Cycle audit: `mobile/docs/audits/cycle-KU-live-tab-feed-contract.md`.
- Focused tests:
  - `mobile/src/__tests__/liveEventFeedService.test.ts`
  - `mobile/src/__tests__/api.test.ts`
- Proof script:
  - `scripts/prove_mobile_live_tab_feed_contract.ts`

Decision:

- Pass for focused backend/data-contract scope.
- Live tab server mode now requests `/api/events?statusGroup=live&includeMobileMarkets=1` directly.
- Backend route proof includes a seeded live event and excludes a same-suffix seeded upcoming event.
- No remaining P1/P2 gaps for the focused Live tab feed contract.

## Cycle KT

Gate status: Pass

Scope: Backend/data-contract gate for visible Home game-card metrics.

Evidence:

- Route/mobile proof: `docs/mobile/harness/cycle-KT-home-event-metrics-contract/cycle-KT-home-event-metrics-contract.json`.
- Cycle audit: `mobile/docs/audits/cycle-KT-home-event-metrics-contract.md`.
- Focused tests:
  - `mobile/src/__tests__/eventCardMetricsService.test.ts`
  - `mobile/src/__tests__/futuresMetricsService.test.ts`
- Proof script:
  - `scripts/prove_mobile_home_event_metrics_contract.ts`

Decision:

- Pass for focused backend/data-contract scope.
- Home game cards now consume backend `events[].metrics.volume24h` and `liquidity`.
- Backend `null` metrics stay unknown instead of converting to false zero or local-count-derived values.
- Remaining P1: provider-sourced 24h volume/open-interest fields if product requires them.

## Cycle KS

Gate status: Pass

Scope: Backend/data-contract gate for visible Home futures metrics.
...
- Cycle audit: `mobile/docs/audits/cycle-KS-home-futures-metrics-contract.md`.
- Focused tests:
  - `mobile/src/__tests__/futuresMetricsService.test.ts`
- Proof script:
  - `scripts/prove_mobile_home_futures_metrics_contract.ts`

Decision:

- Pass for focused backend/data-contract scope.
- Mobile futures metrics no longer synthesize market volume, market liquidity, or outcome volume from outcome count, rank, or probability.
- Backend `market.liquidity` is used when available; unavailable futures volume is displayed as unknown.
- Remaining P1: provider-sourced futures volume/open-interest fields.

## Cycle KR

Gate status: Pass

Scope: Backend/data-contract gate for visible Home futures chart/range controls.

Evidence:

- Route/mobile proof: `docs/mobile/harness/cycle-KR-home-futures-chart-contract/cycle-KR-home-futures-chart-contract.json`.
- Cycle audit: `mobile/docs/audits/cycle-KR-home-futures-chart-contract.md`.
- Focused tests:
  - `src/__tests__/public.market-chart.no-leak.test.ts`
  - `mobile/src/__tests__/futuresChartService.test.ts`
  - `mobile/src/__tests__/api.test.ts`
- Proof script:
  - `scripts/prove_mobile_home_futures_chart_contract.ts`

Decision:

- Pass for focused backend/data-contract scope.
- Backend `/api/markets/:id/chart` supports the visible `1H` range and continues to return public no-leak chart data.
- Mobile server mode hydrates futures market chart state from the route for the selected range.
- Remaining P1: provider-backed futures volume/open-interest metrics beyond price history.
...
Scope: Backend/data-contract gate for Portfolio value-history route wiring.
...
- Cycle audit: `mobile/docs/audits/cycle-KP-portfolio-value-history-contract.md`.
- Focused tests:
  - `src/__tests__/portfolio.value-history.route.test.ts`
  - `mobile/src/__tests__/api.test.ts`
  - `mobile/src/__tests__/portfolioValueHistoryService.test.ts`
- Proof script:
  - `scripts/prove_mobile_portfolio_value_history_contract.ts`

Decision:

- Pass for focused backend/data-contract scope.
- Mobile server mode loads `/api/portfolio/value-history?range=1D` after Portfolio sync.
- Portfolio exposes route source/status/range/point-count for harness proof without a layout redesign.
- Remaining P1: richer Portfolio chart/range controls when that visual cycle is allowed.
...
Scope: Backend/data-contract gate for visible Search row metrics.

Evidence:

- Route/mobile proof: `docs/mobile/harness/cycle-KN-search-metrics-contract/cycle-KN-search-metrics-contract.json`.
- Cycle audit: `mobile/docs/audits/cycle-KN-search-metrics-contract.md`.
- Focused tests:
  - `src/__tests__/public.events.no-leak.test.ts`
  - `mobile/src/__tests__/worldCupAdapter.test.ts`
- Proof script:
  - `scripts/prove_mobile_search_metrics_contract.ts`

Decision:

- Pass for focused backend/data-contract scope.
- `/api/events?includeMobileMarkets=1` now returns backend-owned `events[].metrics`.
- Search rows no longer synthesize volume, today, liquidity, or chat counts in the frontend.
- Remaining P1: real 24h volume and comment/activity routes if those metrics become product requirements.
...
Scope: Backend/data-contract gate for visible Search Saved route filter.

Evidence:

- Route/mobile proof: `docs/mobile/harness/cycle-KL-search-saved-filter/cycle-KL-search-saved-filter.json`.
- Cycle audit: `mobile/docs/audits/cycle-KL-search-saved-filter.md`.
- Focused mobile test:
  - `mobile/src/__tests__/api.test.ts`
- Proof script:
  - `scripts/prove_mobile_search_saved_filter.ts`

Decision:

- Pass for focused backend/data-contract scope.
- Search server mode sends saved event ids to `/api/events` with the active search query.
- `/api/events` filters explicit event ids before pagination and returns compact mobile markets.
- Remaining P1: first-class saved/followed market route if saved state moves beyond profile preferences.

## Cycle KK

Gate status: Pass

Scope: Backend/data-contract gate for visible Home Saved route filter.

Evidence:

- Route/mobile proof: `docs/mobile/harness/cycle-KK-home-saved-filter/cycle-KK-home-saved-filter.json`.
- Cycle audit: `mobile/docs/audits/cycle-KK-home-saved-filter.md`.
- Focused mobile test:
  - `mobile/src/__tests__/api.test.ts`
- Proof script:
  - `scripts/prove_mobile_home_saved_filter.ts`

Decision:

- Pass for focused backend/data-contract scope.
- Home server mode sends saved event ids to `/api/events`.
- `/api/events` filters explicit event ids before pagination and returns compact mobile markets.
- Remaining P1: first-class saved/followed market route if saved state moves beyond profile preferences.
...
Scope: Backend/data-contract gate for visible Home Live/Today route filters.

Evidence:

- Route/mobile proof: `docs/mobile/harness/cycle-KJ-home-status-filters/cycle-KJ-home-status-filters.json`.
- Cycle audit: `mobile/docs/audits/cycle-KJ-home-status-filters.md`.
- Focused mobile test:
  - `mobile/src/__tests__/api.test.ts`
- Proof script:
  - `scripts/prove_mobile_home_status_filters.ts`

Decision:

- Pass for focused backend/data-contract scope.
- Home server mode sends `statusGroup=live` and `statusGroup=today` to `/api/events`.
- `/api/events` filters Live/Today before pagination and returns compact mobile markets.
- Remaining P1: backend-owned saved filter and optional user-local Today boundary semantics.

## Cycle KI

Gate status: Pass

Scope: Backend/data-contract gate for the visible Account profile identity route contract.

Evidence:

- Route/mobile proof: `docs/mobile/harness/cycle-KI-account-profile-contract/cycle-KI-account-profile-contract.json`.
- Cycle audit: `mobile/docs/audits/cycle-KI-account-profile-contract.md`.
- Focused mobile tests:
  - `mobile/src/__tests__/accountProfileService.test.ts`
  - `mobile/src/__tests__/api.test.ts`
- Proof script:
  - `scripts/prove_mobile_account_profile_contract.ts`

Decision:

- Pass for focused backend/data-contract scope.
- Backend exposes canonical `/api/account/profile` with `account:read` auth.
- Mobile maps route-owned `displayName` and uses it for Account profile card state in server mode.
- Remaining P1: full server-authored Account menu destinations/actions and richer Account-specific sync/error copy.

## Cycle KH

Gate status: Pass

Scope: Backend/data-contract gate for the visible Account balance route contract.

Evidence:

- Route/mobile proof: `docs/mobile/harness/cycle-KH-account-balance-contract/cycle-KH-account-balance-contract.json`.
- Cycle audit: `mobile/docs/audits/cycle-KH-account-balance-contract.md`.
- Focused mobile tests:
  - `mobile/src/__tests__/accountBalanceService.test.ts`
  - `mobile/src/__tests__/api.test.ts`
- Proof script:
  - `scripts/prove_mobile_account_balance_contract.ts`

Decision:

- Pass for focused backend/data-contract scope.
- Mobile has a canonical `/api/account/balance` client method and validator.
- Server mode refreshes visible Account balance from `/api/account/balance` when an API key is present.
- Route proof verifies Account balance and Portfolio wallet fields match for the same canonical user.
- Remaining P1: full server-authored account identity/session/menu metadata and richer Account-specific sync/error state.

## Cycle KG

Gate status: Pass

Scope: Backend/data-contract gate for route-backed mobile cashout/sell safety.

Evidence:

- Route proof: `docs/mobile/harness/cycle-KG-route-sell-safety/cycle-KG-route-sell-safety.json`.
- Cycle audit: `mobile/docs/audits/cycle-KG-route-sell-safety.md`.
- Focused mobile test:
  - `mobile/src/__tests__/positionCloseService.test.ts`
- Focused backend test:
  - `src/server/services/__tests__/phase7_kalshi_model.test.ts`
- Proof script:
  - `scripts/prove_mobile_route_sell_safety.ts`

Decision:

- Pass for focused backend/data-contract scope.
- `POST /api/orders` rejects no-position SELL with `409 Insufficient shares`.
- `POST /api/orders` rejects oversell with `409 Insufficient available shares`.
- Rejected route requests leave Portfolio open orders empty and preserve owned shares.
- Valid full-position SELL is accepted and reserves all owned shares.
- Remaining P1: provider-backed close/cashout replay when exact live provider markets are available.
...
Scope: Backend/data-contract gate for selected Spread and Team Total submit -> cancel -> Portfolio/history identity preservation.
...
- Cycle audit: `mobile/docs/audits/cycle-KE-route-line-family-cancel-history.md`.
- Focused mobile tests:
  - `mobile/src/__tests__/orderService.test.ts`
  - `mobile/src/__tests__/portfolioSnapshotService.test.ts`
  - `mobile/src/__tests__/portfolioHistoryService.test.ts`
...
- Focused backend tests:
  ...
  - `src/server/services/__tests__/canonical_order_submission.phase5.test.ts`
- Proof script:
  - `scripts/prove_mobile_route_line_family_cancel_history.ts`

Decision:

- Pass for focused backend/data-contract scope.
- Selected Spread and Team Total line/provider identity is preserved through cancel and canceled-history routes.
- Remaining P1: selected-line filled lifecycle breadth and immutable first-class selection snapshots.

## Cycle KD

Gate status: Pass

Scope: Backend/data-contract gate for actual `/api/orders` route echo breadth across selected Spread and Team Total provider tickets.
...
- Cycle audit: `mobile/docs/audits/cycle-KD-route-order-submit-line-family-breadth.md`.
- Focused mobile tests:
  - `mobile/src/__tests__/orderService.test.ts`
  - `mobile/src/__tests__/portfolioSnapshotService.test.ts`
- Focused backend tests:
  - `src/server/services/__tests__/canonical_order_submission.phase5.test.ts`
- Proof script:
  - `scripts/prove_mobile_route_order_submit_line_family_breadth.ts`

Decision:

- Pass for focused backend/data-contract scope.
- Actual `/api/orders` responses satisfy the mobile selected-line/provider echo guard for Spread and Team Total paths.
- Remaining P1: selected-line filled/canceled lifecycle breadth and immutable first-class selection snapshots.
...
Scope: Backend/data-contract gate for Trade Ticket selected line/provider submit confirmation. This does not claim production breadth for every provider market family.

Evidence:

- Client proof: `docs/mobile/harness/cycle-KB-order-submit-selection-echo/cycle-KB-order-submit-selection-echo.json`.
- Cycle audit: `mobile/docs/audits/cycle-KB-order-submit-selection-echo.md`.
- Focused mobile tests:
  - `mobile/src/__tests__/orderService.test.ts`
- Proof script:
  - `scripts/prove_mobile_order_submit_selection_echo.ts`

Decision:

- Pass for focused backend/data-contract scope.
- Server-mode Trade Ticket submit now requires backend `order.selection` echo for selected line/provider tickets.
- Remaining P1: broader production route replay and immutable first-class selection snapshots.

## Cycle KA

Gate status: Pass

Scope: Backend/data-contract gate for Event Detail Game Lines selector identity. This does not claim real-provider breadth for every visible line family.
...
- Cycle audit: `mobile/docs/audits/cycle-KA-line-selector-backend-selection.md`.
- Focused mobile tests:
  - `mobile/src/__tests__/worldCupAdapter.test.ts`
  - `mobile/src/__tests__/eventDetailLineTicketService.test.ts`
- Focused backend tests:
...
- Route proof script:
  - `scripts/prove_mobile_line_selector_backend_selection.ts`

Decision:

- Pass for focused backend/data-contract scope.
- `markets[].selection` now survives mobile normalization and line-ticket opening.
- Remaining P1: run broader real-provider line-family replay when exact provider-backed spread/totals/team-total markets are available.

## Cycle JZ

Gate status: Pass

Scope: Backend/data-contract gate for Account/settings profile preference load/save. This does not claim production auth/profile/wallet menu completeness.

Evidence:

- Route proof: `docs/mobile/harness/cycle-JZ-account-preferences-contract/cycle-JZ-account-preferences-contract.json`.
- Cycle audit: `mobile/docs/audits/cycle-JZ-account-preferences-contract.md`.
- Focused mobile tests:
  - `mobile/src/__tests__/profilePreferencesService.test.ts`
  - `mobile/src/__tests__/api.test.ts`
- Focused backend tests:
...
- Route proof script:
  - `scripts/prove_mobile_account_preferences_contract.ts`

Decision:

- P0 failed: 0 for focused Account preference load/save contract scope.
- Remaining P1: full server-authored account/session/menu/wallet destination metadata and richer mobile retry/conflict state for sync failures.

## Cycle JY

Gate status: Pass

Scope: Backend/data-contract gate for Trade Ticket filled submit, resulting Portfolio position, and recent trade history. This does not claim full filled/partial UX breadth or visual/device proof.

Evidence:

- Route proof: `docs/mobile/harness/cycle-JY-trade-ticket-filled-lifecycle/cycle-JY-trade-ticket-filled-lifecycle.json`.
- Cycle audit: `mobile/docs/audits/cycle-JY-trade-ticket-filled-lifecycle.md`.
- Focused mobile tests:
  - `mobile/src/__tests__/orderService.test.ts`
  - `mobile/src/__tests__/portfolioSnapshotService.test.ts`
  - `mobile/src/__tests__/portfolioHistoryService.test.ts`
- Route proof script:
  - `scripts/prove_mobile_trade_ticket_filled_lifecycle.ts`

Decision:

- P0 failed: 0 for focused Trade Ticket filled submit/Portfolio/history contract scope.
- Remaining P1: filled lifecycle breadth across more market families and partial-fill states, richer mobile filled/partial status copy, and durable first-class fill/trade selection snapshots.

## Cycle JX

Gate status: Pass

Scope: Backend/data-contract gate for Trade Ticket server submit and resulting Portfolio open order. This does not claim filled lifecycle breadth or visual/device proof.

Evidence:

- Route proof: `docs/mobile/harness/cycle-JX-trade-ticket-submit-contract/cycle-JX-trade-ticket-submit-contract.json`.
- Cycle audit: `mobile/docs/audits/cycle-JX-trade-ticket-submit-contract.md`.
- Focused mobile tests:
  - `mobile/src/__tests__/orderService.test.ts`
  - `mobile/src/__tests__/api.test.ts`
- Route proof script:
  - `scripts/prove_mobile_trade_ticket_submit_contract.ts`

Decision:

- P0 failed: 0 for focused Trade Ticket submit/open-order contract scope.
- Remaining P1: route-backed filled lifecycle for this same ticket path, richer mobile submit error states, and durable first-class order/fill/trade selection snapshots.
...
Scope: Backend/data-contract gate for Portfolio history/activity `contractSide` preservation in server mode. This does not claim resolved-market economics breadth or visual/device proof.

Evidence:

- Route proof: `docs/mobile/harness/cycle-JV-portfolio-history-contract-side/cycle-JV-portfolio-history-contract-side.json`.
- Cycle audit: `mobile/docs/audits/cycle-JV-portfolio-history-contract-side.md`.
- Focused mobile tests:
  - `mobile/src/__tests__/portfolioHistoryService.test.ts`
- Route proof script:
  - `scripts/prove_mobile_portfolio_history_contract_side.ts`

Decision:

- P0 failed: 0 for focused Portfolio canceled-order/recent-trade contract-side scope.
- Remaining P1: first-class immutable order/trade selection snapshots, broader resolved-history economics proof if required, and optional Android Portfolio proof if visual proof is required again.
...
Scope: Backend/data-contract gate for visible Search Live/Upcoming filters in server market-data mode. This does not claim server-side Saved integration, richer ranking/facets, or visual/device proof.

Evidence:

- Route proof: `docs/mobile/harness/cycle-JT-search-status-filters/cycle-JT-search-status-filters.json`.
- Cycle audit: `mobile/docs/audits/cycle-JT-search-status-filters.md`.
- Focused mobile tests:
  - `mobile/src/__tests__/api.test.ts`
- Focused backend tests:
  - selected Search status-group case in `src/__tests__/public.events.no-leak.test.ts`

Decision:

- P0 failed: 0 for focused Search Live/Upcoming route-filter scope.
- Remaining P1: server-side Saved filter integration, richer ranking/facet metadata, and optional Android Search filter proof if visual proof is required again.
...
- Remaining P1: server-side pagination for Home live/today filters, Search tab backend pagination, and optional Android Load more proof if visual proof is required again.

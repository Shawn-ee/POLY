...
| #177 | `docs: refresh UI post-merge state` | Docs-only state refresh | Low by file type, stale by content | Close or update, do not merge as-is | Targets older checkpoint `8db1fd7`; current `dev` is `6474faf` and includes later state-refresh docs through PR #209 and PR #203. |
| #192 | `docs: refresh autonomous checkpoint after pr191` | Draft docs-only checkpoint | Low by file type, stale by content | Close or update, do not merge as-is | Superseded by merged PR #193 and reflected in later queue/checkpoint refreshes through PR #209 and PR #203 on current `dev` checkpoint `6474faf`. |
| #198 | `docs: refresh checkpoint after pr196` | Draft docs-only checkpoint | Low by file type, stale by content | Close or update, do not merge as-is | Superseded by merged PR #199, PR #200, PR #197, PR #201, PR #202, PR #204, PR #208, PR #209, and PR #203 on current `dev` checkpoint `6474faf`. |
| #205 | `docs: refresh checkpoint after pr204` | Draft docs-only checkpoint/evidence refresh | Low by file type, overlapping by content | Close or reconcile, do not merge as-is | Overlaps the checkpoint lane now covered by PR #208, PR #209, and the post-PR #203 checkpoint; also adds a not-run route-smoke evidence placeholder that should be reconciled before merge. |
| #206 | `docs: refresh checkpoint after pr204` | Draft docs-only checkpoint refresh | Low by file type, overlapping by content | Close or reconcile, do not merge as-is | Duplicates the post-PR #204 checkpoint refresh intent now covered by PR #208, PR #209, and the post-PR #203 checkpoint; reconcile before merge. |
| #207 | `docs: refresh checkpoint after pr204` | Draft docs-only checkpoint refresh | Low by file type, overlapping by content | Close or reconcile, do not merge as-is | Duplicates the post-PR #204 checkpoint refresh intent now covered by PR #208, PR #209, and the post-PR #203 checkpoint; reconcile before merge. |
...
4. PR #198: stale draft docs-only checkpoint superseded by PR #199, PR #200, PR #197, PR #201, PR #202, PR #204, PR #208, PR #203, and PR #209; close as superseded or update from current `dev`.
5. PR #205: draft checkpoint/evidence refresh after PR #204; reconcile or close because it overlaps PR #208, PR #209, and the post-PR #203 checkpoint.
6. PR #206: draft checkpoint refresh after PR #204; reconcile or close because it overlaps PR #208, PR #209, and the post-PR #203 checkpoint.
7. PR #207: draft checkpoint refresh after PR #204; reconcile or close because it overlaps PR #208, PR #209, and the post-PR #203 checkpoint.
...
11. PR #209: merged as docs-only checkpoint refresh after PR #203.

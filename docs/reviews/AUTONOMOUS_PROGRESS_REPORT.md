...
3. Close or update stale draft docs-only PR #192, which is superseded by merged PR #193 and reflected in the merged PR #194 and PR #196 queue/checkpoint refreshes.

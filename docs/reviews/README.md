...
- Public API and route-smoke safety:
  ...
  - `PUBLIC_ROUTE_SMOKE_ANONYMOUS_CHECKLIST.md`
  - `PUBLIC_ROUTE_SMOKE_MOBILE_VIEWPORT_CHECKLIST.md`
  - `PUBLIC_ROUTE_SMOKE_EVIDENCE_2026_06_18_NOT_RUN.md`
  - `PUBLIC_ROUTE_SMOKE_EVIDENCE_2026_06_19_NOT_RUN.md`
- UI standardization:
  - `UI_STANDARDIZATION_PROGRESS.md`
  - `UI_PAGE_STATUS_MATRIX.md`
  - `HOMEPAGE_WALLET_ADMIN_SURFACE_DECISION.md`
  - `UI_COPY_TERMINOLOGY_GUIDE.md`
  - `UI_EMPTY_LOADING_ERROR_STATES.md`
  - `UI_STATE_TERMINOLOGY_MAP.md`
  - `MARKET_DETAIL_SCREENSHOT_SMOKE_CHECKLIST.md`

...
This document summarizes open PRs that the autonomous LeadAgent has inspected but must not auto-merge under the current safety policy. The latest merged checkpoint refresh is PR #196 at `021c905`; the latest dedicated queue refresh is PR #194 at `2740a69`.

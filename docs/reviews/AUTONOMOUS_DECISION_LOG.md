...
- `agent/current-dev-checkpoint-pr194-refresh` was selected because current `dev` contains merged PR #194 and several checkpoint/progress docs still pointed at the earlier `b697302` checkpoint.

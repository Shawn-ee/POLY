...
- `agent/current-dev-checkpoint-pr204-refresh` was selected because current `dev` contains merged PR #204 and several checkpoint trackers still pointed at the earlier `6e618e7` checkpoint.
